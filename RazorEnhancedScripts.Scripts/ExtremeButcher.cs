...
namespace RazorEnhancedScripts.Scripts
{
    public class ExtremeButcher
    {
        ...
        private readonly int _scissors = 0x0F9F;
        private bool _lootedHides;
        ...
        public void Run()
        {
            ...
            Item scissors = DigDeep(Player.Backpack, _scissors);
            ...
            if (_lootedHides && scissors != null)
            {
                Misc.Pause(500);
                var hide = Items.FindByID(_hide, -1, Player.Backpack.Serial, true);
                if (hide != null)
                {
